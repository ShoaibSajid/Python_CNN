...
Path('weights/temp/fc').mkdir( parents=True, exist_ok=True )
...
class FC:
  ...
  def __init__(self, input_len, nodes):
    ...
    np.save('weights/temp/fc/linear_filters',self.weights)
    np.save('weights/temp/fc/linear_biases' ,self.biases)
