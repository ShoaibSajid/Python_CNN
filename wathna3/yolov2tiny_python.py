...
class WeightLoader(object):
	...
	def load_conv_bn(self, conv_model, bn_model):
		...
		if bn_model.bias.data.shape == self.scratch.p['beta0'].shape:
			self.scratch.p['beta0'] = bn_model.bias.data
			with open('./weight_parameter/bn_param/bias/{}'.format(0), mode='w') as f:
				f.write(str(bn_model.bias.data))
		elif bn_model.bias.data.shape == self.scratch.p['beta1'].shape:
			self.scratch.p['beta1'] = bn_model.bias.data
			with open('./weight_parameter/bn_param/bias/{}'.format(1), mode='w') as f:
				f.write(str(bn_model.bias.data))
		elif bn_model.bias.data.shape == self.scratch.p['beta2'].shape:
			self.scratch.p['beta2'] = bn_model.bias.data
			with open('./weight_parameter/bn_param/bias/{}'.format(2), mode='w') as f:
				f.write(str(bn_model.bias.data))
		elif bn_model.bias.data.shape == self.scratch.p['beta3'].shape:
			self.scratch.p['beta3'] = bn_model.bias.data
			with open('./weight_parameter/bn_param/bias/{}'.format(3), mode='w') as f:
				f.write(str(bn_model.bias.data))
		elif bn_model.bias.data.shape == self.scratch.p['beta4'].shape:
			self.scratch.p['beta4'] = bn_model.bias.data
			with open('./weight_parameter/bn_param/bias/{}'.format(4), mode='w') as f:
				f.write(str(bn_model.bias.data))
		elif bn_model.bias.data.shape == self.scratch.p['beta5'].shape:
			self.scratch.p['beta5'] = bn_model.bias.data
			with open('./weight_parameter/bn_param/bias/{}'.format(5), mode='w') as f:
				f.write(str(bn_model.bias.data))
		elif (bn_model.bias.data.shape == self.scratch.p['beta6'].shape) and self.b == "b":
			self.scratch.p['beta6'] = bn_model.bias.data
			with open('./weight_parameter/bn_param/bias/{}'.format(6), mode='w') as f:
				f.write(str(bn_model.bias.data))
			self.b = 'bb'
		elif (self.scratch.p['beta7'].shape == bn_model.bias.data.shape) and self.b == "bb":
			self.scratch.p['beta7'] = bn_model.bias.data
		...
		if bn_model.weight.data.shape == self.scratch.p['gamma0'].shape:
			self.scratch.p['gamma0'] = bn_model.weight.data
			with open('./weight_parameter/bn_param/gamma/{}'.format(0), mode='w') as f:
				f.write(str(bn_model.weight.data))
		elif bn_model.weight.data.shape == self.scratch.p['gamma1'].shape:
			self.scratch.p['gamma1'] = bn_model.weight.data
			with open('./weight_parameter/bn_param/gamma/{}'.format(1), mode='w') as f:
				f.write(str(bn_model.weight.data))
		elif bn_model.weight.data.shape == self.scratch.p['gamma2'].shape:
			self.scratch.p['gamma2'] = bn_model.weight.data
			with open('./weight_parameter/bn_param/gamma/{}'.format(2), mode='w') as f:
				f.write(str(bn_model.weight.data))
		elif bn_model.weight.data.shape == self.scratch.p['gamma3'].shape:
			self.scratch.p['gamma3'] = bn_model.weight.data
			with open('./weight_parameter/bn_param/gamma/{}'.format(3), mode='w') as f:
				f.write(str(bn_model.weight.data))
		elif bn_model.weight.data.shape == self.scratch.p['gamma4'].shape:
			self.scratch.p['gamma4'] = bn_model.weight.data
			with open('./weight_parameter/bn_param/gamma/{}'.format(4), mode='w') as f:
				f.write(str(bn_model.weight.data))
		elif bn_model.weight.data.shape == self.scratch.p['gamma5'].shape:
			self.scratch.p['gamma5'] = bn_model.weight.data
			with open('./weight_parameter/bn_param/gamma/{}'.format(5), mode='w') as f:
				f.write(str(bn_model.weight.data))
		elif (bn_model.weight.shape == self.scratch.p['gamma6'].shape) and self.g == "g":
			self.scratch.p['gamma6'] = bn_model.weight.data
			with open('./weight_parameter/bn_param/gamma/{}'.format(6), mode='w') as f:
				f.write(str(bn_model.weight.data))
			self.g = 'gg'
		elif (self.scratch.p['gamma7'].shape == bn_model.weight.data.shape) and self.g == "gg":
			self.scratch.p['gamma7'] = bn_model.weight.data
		...
		if conv_model.weight.data.shape == (16, 3, 3, 3):
			self.scratch.p['W0'] = conv_model.weight.data
...
python__model = DeepConvNet(     input_dims=(3, 416, 416),
...
if _Load_Weights:
	...
	python__model = weightloader.load(python__model, model, './data/pretrained/yolov2-tiny-voc.weights')
...
if __name__ == '__main__':
	if os.path.isdir("Outputs/Python"): shutil.rmtree("Outputs/Python")
