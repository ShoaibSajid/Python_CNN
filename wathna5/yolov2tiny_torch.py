...
#         if bn_model.bias.data.shape == scratch.p['beta0'].shape:
#             scratch.p['beta0'] = bn_model.bias.data
#             with open('./weight_parameter/bn_param/bias/{}'.format(0), mode='w') as f:
#                 f.write(str(bn_model.bias.data))
#         elif bn_model.bias.data.shape == scratch.p['beta1'].shape:
#             scratch.p['beta1'] = bn_model.bias.data
#             with open('./weight_parameter/bn_param/bias/{}'.format(1), mode='w') as f:
#                 f.write(str(bn_model.bias.data))
#         elif bn_model.bias.data.shape == scratch.p['beta2'].shape:
#             scratch.p['beta2'] = bn_model.bias.data
#             with open('./weight_parameter/bn_param/bias/{}'.format(2), mode='w') as f:
#                 f.write(str(bn_model.bias.data))
#         elif bn_model.bias.data.shape == scratch.p['beta3'].shape:
#             scratch.p['beta3'] = bn_model.bias.data
#             with open('./weight_parameter/bn_param/bias/{}'.format(3), mode='w') as f:
#                 f.write(str(bn_model.bias.data))
#         elif bn_model.bias.data.shape == scratch.p['beta4'].shape:
#             scratch.p['beta4'] = bn_model.bias.data
#             with open('./weight_parameter/bn_param/bias/{}'.format(4), mode='w') as f:
#                 f.write(str(bn_model.bias.data))
#         elif bn_model.bias.data.shape == scratch.p['beta5'].shape:
#             scratch.p['beta5'] = bn_model.bias.data
#             with open('./weight_parameter/bn_param/bias/{}'.format(5), mode='w') as f:
#                 f.write(str(bn_model.bias.data))
#         elif (bn_model.bias.data.shape == scratch.p['beta6'].shape) and self.b == "b":
#             scratch.p['beta6'] = bn_model.bias.data
#             with open('./weight_parameter/bn_param/bias/{}'.format(6), mode='w') as f:
#                 f.write(str(bn_model.bias.data))
#             self.b = 'bb'
#         elif (scratch.p['beta7'].shape == bn_model.bias.data.shape) and self.b == "bb":
#             scratch.p['beta7'] = bn_model.bias.data
...
#         if bn_model.weight.data.shape == scratch.p['gamma0'].shape:
#             scratch.p['gamma0'] = bn_model.weight.data
#             with open('./weight_parameter/bn_param/gamma/{}'.format(0), mode='w') as f:
#                 f.write(str(bn_model.weight.data))
#         elif bn_model.weight.data.shape == scratch.p['gamma1'].shape:
#             scratch.p['gamma1'] = bn_model.weight.data
#             with open('./weight_parameter/bn_param/gamma/{}'.format(1), mode='w') as f:
#                 f.write(str(bn_model.weight.data))
#         elif bn_model.weight.data.shape == scratch.p['gamma2'].shape:
#             scratch.p['gamma2'] = bn_model.weight.data
#             with open('./weight_parameter/bn_param/gamma/{}'.format(2), mode='w') as f:
#                 f.write(str(bn_model.weight.data))
#         elif bn_model.weight.data.shape == scratch.p['gamma3'].shape:
#             scratch.p['gamma3'] = bn_model.weight.data
#             with open('./weight_parameter/bn_param/gamma/{}'.format(3), mode='w') as f:
#                 f.write(str(bn_model.weight.data))
#         elif bn_model.weight.data.shape == scratch.p['gamma4'].shape:
#             scratch.p['gamma4'] = bn_model.weight.data
#             with open('./weight_parameter/bn_param/gamma/{}'.format(4), mode='w') as f:
#                 f.write(str(bn_model.weight.data))
#         elif bn_model.weight.data.shape == scratch.p['gamma5'].shape:
#             scratch.p['gamma5'] = bn_model.weight.data
#             with open('./weight_parameter/bn_param/gamma/{}'.format(5), mode='w') as f:
#                 f.write(str(bn_model.weight.data))
#         elif (bn_model.weight.shape == scratch.p['gamma6'].shape) and self.g == "g":
#             scratch.p['gamma6'] = bn_model.weight.data
#             with open('./weight_parameter/bn_param/gamma/{}'.format(6), mode='w') as f:
#                 f.write(str(bn_model.weight.data))
#             self.g = 'gg'
#         elif (scratch.p['gamma7'].shape == bn_model.weight.data.shape) and self.g == "gg":
#             scratch.p['gamma7'] = bn_model.weight.data
...
#             scratch.p['W0'] = conv_model.weight.data
...
im_data = im_data.to(torch.float64)
gt_boxes = gt_boxes[0].unsqueeze(0)
# gt_boxes = gt_boxes.to(torch.float64)
gt_classes = gt_classes[0].unsqueeze(0)
# gt_classes = gt_classes.to(torch.float64)
num_obj = num_obj[0].unsqueeze(0)
# num_obj = num_obj.to(torch.float64)
# def demo():
#     args = parse_args()
...
#     weight_loader.load(model, './data/pretrained/yolov2-tiny-voc.weights')
#     print('loaded')
...
#         yolo_output = scratch.loss(im_data_variable)
...
#             plt.imshow(im2show)
#             plt.show()
#             plt.savefig(f"./demo3/{image_name}_result.png")
