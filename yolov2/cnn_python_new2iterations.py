    ...
    if save_txt or save_hex:
        if type(data) is dict:
            ...
            if module == [] and layer_no == []:
                Out_Path = f'Outputs_python_new2iterations/{os.path.split(fname)[0]}'
                fname = os.path.split(fname)[1]
            else:
                Out_Path = f'Outputs_python_new2iterations/By_Layer/'
  ...
  """
    ...
    def forward(self, X):
       ...
       #4
        ...
        mean, var = Cal_mean_var.forward(temp_Out[6], layer_no=7, save_txt=self.save_txt, save_hex=self.save_hex, phase=self.phase)
        ...
        mean, var = Cal_mean_var.forward(Out[8], layer_no=8, save_txt=self.save_txt, save_hex=self.save_hex, phase=self.phase)
    ...
    def backward(self, dout, cache):
        ...
        #     save_file(f'Outputs/Python/Backwards/dOut_Layer_{_key}.txt', dOut[_key])
        #   for _key in grads.keys():
        #     save_file(f'Outputs/Python/Backwards/grads_Layer_{_key}.txt', grads[_key])
...
class Python_Conv(object):
    ...
    """
        ...
        save_file('Input_img1', x[0:1], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img2', x[1:2], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img3', x[2:3], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img4', x[3:4], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img5', x[4:5], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img6', x[5:6], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img7', x[6:7], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img8', x[7:8], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)

        save_file('Weight', w, module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        ...
        save_file('Output_img1', out[0:1], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img2', out[1:2], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img3', out[2:3], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img4', out[3:4], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img5', out[4:5], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img6', out[5:6], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img7', out[6:7], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img8', out[7:8], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
    ...
    """
        ...
        save_file('Input_Gradient(upstream_derivative)_img1', dout[0:1], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img2', dout[1:2], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img3', dout[2:3], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img4', dout[3:4], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img5', dout[4:5], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img6', dout[5:6], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img7', dout[6:7], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img8', dout[7:8], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Weight', w, module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        ...
        save_file('Gradient_of_Input_img1', dx[0:1], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img2', dx[1:2], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img3', dx[2:3], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img4', dx[3:4], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img5', dx[4:5], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img6', dx[5:6], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img7', dx[6:7], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img8', dx[7:8], module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        
        
        
        save_file('Gradient_of_Weight', dw, module='Conv', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
...
class Python_ConvB(object):
    ...
    """
        save_file('Input_img1', x[0:1], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img2', x[1:2], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img3', x[2:3], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img4', x[3:4], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img5', x[4:5], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img6', x[5:6], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img7', x[6:7], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img8', x[7:8], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)

        save_file('Weight', w, module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        ...
        save_file('Output_img1', out[0:1], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img2', out[1:2], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img3', out[2:3], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img4', out[3:4], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img5', out[4:5], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img6', out[5:6], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img7', out[6:7], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img8', out[7:8], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
    ...
    """
        ...
        save_file('Input_Gradient(upstream_derivative)_img1', dout[0:1], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img2', dout[1:2], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img3', dout[2:3], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img4', dout[3:4], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img5', dout[4:5], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img6', dout[5:6], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img7', dout[6:7], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img8', dout[7:8], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        ...
        save_file('Gradient_of_Input_img1', dx[0:1], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img2', dx[1:2], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img3', dx[2:3], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img4', dx[3:4], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img5', dx[4:5], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img6', dx[5:6], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img7', dx[6:7], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img8', dx[7:8], module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        
        save_file('Gradient_of_Weight', dw, module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Bias', db, module='ConvWB', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
...
class Python_MaxPool(object):
    ...
    """
        ...
        save_file('Input_img1', x[0:1], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img2', x[1:2], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img3', x[2:3], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img4', x[3:4], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img5', x[4:5], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img6', x[5:6], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img7', x[6:7], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img8', x[7:8], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        ...
        save_file(f'MaxPooling_ForwardPosition_Layer{layer_no}', positions, module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file('Output_img1', out[0:1], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img2', out[1:2], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img3', out[2:3], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img4', out[3:4], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img5', out[4:5], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img6', out[5:6], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img7', out[6:7], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img8', out[7:8], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        
        # Sign of Max Value in MaxPooling: 
        sign = torch.zeros_like(out)
        sign[out < 0] = 1
        save_file(f'Sign_MaxPooling_image1_Layer{layer_no}', sign[0:1], module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Sign_MaxPooling_image2_Layer{layer_no}', sign[1:2], module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Sign_MaxPooling_image3_Layer{layer_no}', sign[2:3], module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Sign_MaxPooling_image4_Layer{layer_no}', sign[3:4], module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Sign_MaxPooling_image5_Layer{layer_no}', sign[4:5], module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Sign_MaxPooling_image6_Layer{layer_no}', sign[5:6], module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Sign_MaxPooling_image7_Layer{layer_no}', sign[6:7], module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Sign_MaxPooling_image8_Layer{layer_no}', sign[7:8], module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)
    ...
    """
        ...
        save_file('Input_Gradient(upstream_derivative)_img1', dout[0:1], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img2', dout[1:2], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img3', dout[2:3], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img4', dout[3:4], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img5', dout[4:5], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img6', dout[5:6], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img7', dout[6:7], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img8', dout[7:8], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        ...
        save_file(f'MaxPooling_BackwardPosition_Layer{layer_no}', backward_positions, module='MaxPool', layer_no=layer_no, save_txt=save_txt, phase=phase)

        save_file('Gradient_of_Input_img1', dx[0:1], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img2', dx[1:2], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img3', dx[2:3], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img4', dx[3:4], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img5', dx[4:5], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img6', dx[5:6], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img7', dx[6:7], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradient_of_Input_img8', dx[7:8], module='MaxPool', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
...
class Python_BatchNorm(object):
    ...
    """
        ...
        save_file(f'Beta_{layer_no}', beta, module='BatchNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Gamma_{layer_no}', gamma, module='BatchNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        ...
        save_file(f'running_mean_{layer_no}', running_mean, module='BatchNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'running_var_{layer_no}', running_var, module='BatchNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        ...
        save_file('Output', out, module='BatchNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
...
class Python_ReLU(object):
    ...
    def forward(x, alpha=0.1, layer_no=[], save_txt=False, save_hex=False, phase=[]):
        ...
        save_file('Input_img1', x[0:1], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img2', x[1:2], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img3', x[2:3], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img4', x[3:4], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img5', x[4:5], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img6', x[5:6], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img7', x[6:7], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img8', x[7:8], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        ...
        save_file('Output_img1', out[0:1], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img2', out[1:2], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img3', out[2:3], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img4', out[3:4], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img5', out[4:5], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img6', out[5:6], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img7', out[6:7], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img8', out[7:8], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
    ...
    def backward(dout, cache, alpha=0.1, layer_no=[], save_txt=False, save_hex=False, phase=[]):
        ...
        save_file('Input_Gradient(upstream_derivative)_img1', dout[0:1], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img2', dout[1:2], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img3', dout[2:3], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img4', dout[3:4], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img5', dout[4:5], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img6', dout[5:6], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img7', dout[6:7], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img8', dout[7:8], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)

        dl = torch.ones_like(x)
        dl[x < 0] = alpha
        dx = dout * dl

        save_file('Gradients_of_Input_img1', dx[0:1], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Gradients_of_Input_img2', dx[1:2], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Gradients_of_Input_img3', dx[2:3], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Gradients_of_Input_img4', dx[3:4], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Gradients_of_Input_img5', dx[4:5], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Gradients_of_Input_img6', dx[5:6], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Gradients_of_Input_img7', dx[6:7], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Gradients_of_Input_img8', dx[7:8], module='ReLU', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
...
class Cal_mean_var(object):
    ...
    def forward(x, layer_no=[], save_txt=False, save_hex=False, phase=[]):
        ...
        save_file('mean', avg, module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('variance(scale)', scale, module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
...
# class Python_Conv_BatchNorm_ReLU_Pool2iter(object):

#     @staticmethod
#     def forward(x, w, gamma, beta, conv_param, bn_params, pool_param, layer_no=[], save_txt=False, save_hex=False,
#                 phase=[]):
#         a, conv_cache = Python_Conv.forward(
#             x,
#             w,
...
class Python_SpatialBatchNorm(object):
    ...
    def forward(x, gamma, beta, bn_params, mean, var, layer_no=[], save_txt=False, save_hex=False, phase=[]):
        ...
        save_file('Input_img1', x[0:1], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img2', x[1:2], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img3', x[2:3], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img4', x[3:4], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img5', x[4:5], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img6', x[5:6], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img7', x[6:7], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_img8', x[7:8], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)

        save_file(f'Beta_{layer_no}', beta, module='LightNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Gamma_{layer_no}', gamma, module='LightNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Scale{layer_no}', var, module='LightNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Mean{layer_no}', mean, module='LightNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'RunningMean_{layer_no}', bn_params['running_mean'], module='LightNorm', layer_no=layer_no,
                  save_txt=save_txt, phase=phase)
        save_file(f'RunningVar_{layer_no}', bn_params['running_var'], module='LightNorm', layer_no=layer_no,
                  save_txt=save_txt, phase=phase)
        save_file('Output_img1', output[0:1], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img2', output[1:2], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img3', output[2:3], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img4', output[3:4], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img5', output[4:5], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img6', output[5:6], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img7', output[6:7], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Output_img8', output[7:8], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
    ...
    def backward(grad_output, cache, layer_no=[], save_txt=False, save_hex=False, phase=[]):
        ...
        save_file('Input_Gradient(upstream_derivative)_img1', grad_output[0:1], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img2', grad_output[1:2], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img3', grad_output[2:3], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img4', grad_output[3:4], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img5', grad_output[4:5], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img6', grad_output[5:6], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img7', grad_output[6:7], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        save_file('Input_Gradient(upstream_derivative)_img8', grad_output[7:8], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt, phase=phase)
        
        
        save_file(f'Beta_{layer_no}', dL_dbeta, module='LightNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'Gamma_{layer_no}', dL_dgamma, module='LightNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        
        save_file(f'average_per_channel{layer_no}', avg_pc, module='LightNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        save_file(f'backward_const{layer_no}', backward_const, module='LightNorm', layer_no=layer_no, save_txt=save_txt, phase=phase)
        
        save_file('Gradint_of_Input_img1', dl_dxi[0:1], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradint_of_Input_img2', dl_dxi[1:2], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradint_of_Input_img3', dl_dxi[2:3], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradint_of_Input_img4', dl_dxi[3:4], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradint_of_Input_img5', dl_dxi[4:5], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradint_of_Input_img6', dl_dxi[5:6], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradint_of_Input_img7', dl_dxi[6:7], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
        save_file('Gradint_of_Input_img8', dl_dxi[7:8], module='LightNorm', layer_no=layer_no, save_hex=save_hex, save_txt=save_txt,
                  phase=phase)
